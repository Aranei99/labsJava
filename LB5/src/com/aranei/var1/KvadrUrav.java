...
public class KvadrUrav {
    ...
    public KvadrUrav(double A, double B, double C) {
        ...
        if (A == 0 | B == 0) throw new ArithmeticException("zero a or b");
    }

    public void setA(double A) {
        this.a = A;
        if (A == 0) throw new ArithmeticException("zero a");
    }

    public void setB(double B) {
        this.b = B;
        if (B == 0) throw new ArithmeticException("zero b");
    }
    ...
    public ArrayList<Double> vectorComplex(ArrayList<KvadrUrav> array)  {
        ...
        for (KvadrUrav kvadrUrav : array) {
            if (kvadrUrav.getXs() == 2.0) {
                if (result.get(0) > kvadrUrav.getX2()) result.set(0, kvadrUrav.getX2());
                if (result.get(1) < kvadrUrav.getX2()) result.set(1, kvadrUrav.getX2());
            }
            if (result.get(0) > kvadrUrav.getX1()) result.set(0, kvadrUrav.getX1());
            if (result.get(1) < kvadrUrav.getX1()) result.set(1, kvadrUrav.getX1());
        }
        return result;
    }
